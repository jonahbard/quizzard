...
struct TutorialPage: Identifiable {
    ...
    static var pages: [TutorialPage] = [
        ...
        TutorialPage(name: "for best results, turn off auto-lock in device settings.", description: "navigate to settings > display and brightness > auto-lock and select \"never\".", image: "auto-lock", index: 3)
    ]
